...
public class UserController {
	...
	public String processLoginForm(@RequestParam String email, 
			@RequestParam String password,Model map, HttpSession session, RedirectAttributes flashMap) {
		...
		try {
			...
			flashMap.addFlashAttribute("message","Login Successful");// store it under flash scope (till immediate next request)
			//authorization
