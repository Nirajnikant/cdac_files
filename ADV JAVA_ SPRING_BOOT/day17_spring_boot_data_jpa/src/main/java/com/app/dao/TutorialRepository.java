...
public interface TutorialRepository extends JpaRepository<Tutorial, Integer> {
	...
	// in the asence of inherited sitable API or finder method, can create custom
	// query methods
	@Query("select t.tutorialName from Tutorial t where t.topic.id=:tid order by t.visits desc")
