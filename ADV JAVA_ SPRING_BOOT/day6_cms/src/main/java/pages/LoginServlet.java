...
public class LoginServlet extends HttpServlet {
	...
	public void init() throws ServletException {
		// dao instance
		try {
			// how to get servlet specific init-params?
			// 1. get servlet config
			ServletConfig config = getServletConfig();
			// method of ServletConfig, to access init params
			// String getInitParameter(String name)
 			DBUtils.openConnection(config.getInitParameter("db_url"), config.getInitParameter("user_name"), config.getInitParameter("password"));
