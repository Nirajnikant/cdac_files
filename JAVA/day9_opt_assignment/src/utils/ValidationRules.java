...
public class ValidationRules {
	...
	private static void emailValidate(Customer[] customers,String email) throws CustomerHandlingException {
		...
		System.out.println("Email Validated :: No Duplicates found");
//		.*[@]*.com$
	}
	
	private static void passwordValidate(String password) throws CustomerHandlingException {
	...
	public static CustomerType valCustomerType(String type) throws CustomerHandlingException {
	...
	public static Customer validateCust(String name, String email, String password, double registrationAmount, String dateOfBirth, String type, Customer[] customers) throws CustomerHandlingException, ParseException {
		emailValidate(customers, email);
		passwordValidate(password);
		Date d1 = parseAndValidate(dateOfBirth);
		CustomerType type1 = valCustomerType(type);
