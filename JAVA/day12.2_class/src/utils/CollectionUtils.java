...
public class CollectionUtils {
	//add a static method to return populated ArrayList<Vehicle>
	public static ArrayList<Vehicle> populateVehicleList() throws ParseException, VehicleHandlingException {
		...
		vehicles.add(new Vehicle(12333,"black", 65678, parseAndValidateDate("2-7-2021"), validateCategory("Petrol")));
		vehicles.add(new Vehicle(12346,"white", 55678, parseAndValidateDate("12-10-2021"), validateCategory("Petrol")));
		...
		return vehicles;// returns populated AL to the caller
	}
}
